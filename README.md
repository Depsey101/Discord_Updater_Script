...
I made this little script to fix Discord updates on Linux (that are installed using the native .deb package). This is provided as is, use at your own risk, don't run anything you don't understand, and I will NOT be updating this anymore. I'm done with Discord.
